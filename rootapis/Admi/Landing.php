...
<script type="text/javascript">
    ...
    <div id="Container">
        ...
        <div id="Body" class="simple-body">
            ...
            <p>Temporary administration pages for administrators to use. Designed hastily by <a href="https://www.<?= $domain ?>/users/2/profile"><?= UserAuthentication::lookupNameById(2) ?></a>.</p>
            </div>
            <div class="dark-box" style="margin:15px">
            <h3>Moderation Tools</h3>
            <br>
            Tools to carry out site moderation to ensure we keep the site safe and friendly for all users.
            <p>
            <a href="/Admi/ModerateUser.aspx"><span class="btn-small btn-primary">Moderate User</span></a>
            <a href="/Admi/ModerateReport.aspx"><span class="btn-small btn-primary">Moderate Report</span></a>
            <a href="/Admi/ModerateAsset.aspx"><span class="btn-small btn-primary">Moderate Asset</span></a>
            </p>
            </div>
            ...
            <h3>Other</h3>
            <br>
            Other site management tools that are available depending on your rank.
            <p>
            <?php if ($adminStatus == 2): ?>
                <a href="/Admi/ChangeSiteBanner.aspx"><span class="btn-small btn-neutral">Change Banner</span></a>
                <a href="/Admi/UserVerification.aspx"><span class="btn-small btn-neutral">User Access Link Management</span></a>
            <?php else: ?>
                <p>There are no other tools available for you.</p>
            <?php endif; ?>
            </p>
            </div>
        </div>
