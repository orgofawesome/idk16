...
<head>
    ...
    <title>Site Banner - <?= $domain ?></title>
...
<script type="text/javascript">
    ...
    <div id="Container">
        ...
        <div id="Body" class="simple-body">
            ...
            <p>Allows you to change the website banner. This is exclusively available to administrators so please bear that in mind.</p>
            </div>
            <div class="dark-box" style="margin:15px">
            <h3>Visibility</h3>
            <br>
            Choose whether the site banner is visible or not.
            <p>
            <a href="api.whatever.dothis"><span class="btn-small btn-primary">Enable</span></a>
            <a href="api.whatever.dothis"><span class="btn-small btn-primary">Disable</span></a>
            </p>
            </div>
            ...
            <h3>Set Text</h3>
            <br>
            Choose what the IDK16 site information banner displays.
            <p>Presets that can be used, where necessary:
            <ul class="nav nav-pills">
            <li>
                The site will be coming down shortly for maintenance.
            </li>
            <br>
            <li>
                IDK16 is currently undergoing maintenance. You may encounter connectivity issues.
            </li>
            </ul>
            </p>
            <p>
            ...
            <form action="">
                <input type="text" class="text-box text-box-large" id="reason" name="reason" value="" style="width:865px" />
