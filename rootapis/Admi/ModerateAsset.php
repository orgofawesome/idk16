...
<head>
    ...
    <title>Asset Moderation - <?= $domain ?></title>
...
<script type="text/javascript">
    ...
    <div id="Container">
        ...
        <div id="Body" class="simple-body">
            ...
            <p>Not currently implemented. For the time being, to remove harmful content, report it and then use the report moderation form.</p>
            </div>
        </div>
