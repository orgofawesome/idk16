...
<script type="text/javascript">
    ...
    <div id="navContent" class="nav-content
                                ...
                                <?php if ($isUserAuthenticated) echo 'logged-in'; else echo 'logged-out'; ?>">
...
<script type="text/javascript">
    ...
    function minimalModal() {
        Roblox.GenericConfirmation.open({
            ...
            onAccept: function () { alert("Accepted!"); }
        });
    }
    ...
    function cancelCustomModal() {
        Roblox.GenericConfirmation.open({
            ...
            bodyContent: 'Your message goes here',
            xToCancel: true,
            onCancel: function () { alert("Custom cancel!"); },
            onAccept: function () { alert("Accepted!"); }
        });
    }
    ...
    function imageModal() {
        Roblox.GenericConfirmation.open({
            titleText: 'Warning',
            bodyContent: 'Your message goes here',
            onAccept: function () { alert("Warned!"); },
            imageUrl: "https://static.idk18.xyz/images/Icons/img-alert.png"
        });
    }
    ...
    function nondismissModal() {
        Roblox.GenericConfirmation.open({
            ...
            bodyContent: 'Your message goes here',
            onAccept: function () { alert("Oh you closed it... cool."); },
            onDecline: function () { alert("Oh you closed it... cool.") },
    ...
    function shebangModal() {
        Roblox.GenericConfirmation.open({
            ...
            onAccept: function () { alert("Congratulations! You just bought Roblox!"); },
            onDecline: function () { alert("Awww, you could have bought Roblox!"); },
            imageUrl: "https://static.idk18.xyz/images/Icons/thumbs_up.png",
            allowHtmlContentInBody: true,
            dismissable: false
        });
    }
