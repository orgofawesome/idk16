...
<div id="navContent" class="nav-content">
    ...
    <div id="needsEmailVerification" class="StandardBox" style="width: 880px;">
        <center>
            <br />
            <br />
            <div style="font-size: 14px;">
                An email has been sent to your parent(s). Please ask them to check their email and
                click the link to validate your account. Thank you.
            </div>
            <br />
            <br />
